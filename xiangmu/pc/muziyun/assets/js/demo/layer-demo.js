        ...
        switch(index){
            ...
            case 4:
                $.layer({
                    ...
                    border: [0],
                    area: ['380px', '500px'],
                    iframe: {src: 'http://www.alimoban.com/?wap'}
                }); 
            break;
            case 5:
                ...
                $.layer({
                    ...
                    shift: 'right-bottom',
                        ...
                        $.layer({
                            ...
                            iframe: {
                                src: 'http://www.alimoban.com/?nowap'
                            } 
                        });
                    }
                });
    ...
    switch(type){
        ...
        case 'tab':
            ...
            layer.tab({
                ...
                data: [{
                    title: '博客', 
                    content: tabIframe('http://www.alimoban.com/?nowap')
                }, {
                    title: 'Belite主题', 
                    content: tabIframe('http://www.alimoban.com')
                }, {
                    title: 'MU+后台主题', 
                    content: '<div class="col-sm-12 m-t"><blockquote class="text-warning" style="font-size:14px">您是否需要自己做一款后台、会员中心等等的，但是又缺乏html等前端知识…<br>您是否一直在苦苦寻找一款适合自己的后台主题…<br>您是否想做一款自己的web应用程序…<br>…………<h4 class="text-danger">那么，现在MU+来了</h4></blockquote></div>'
                }]
            });
        break;
        case 'photos':
            ...
            if(conf.photoJSON){
                ...
                layer.load();
                $.getJSON('assets/data/layer/photos.json', {}, function(json){
                    conf.photoJSON = json;
                    layer.photos({
                        html: imghtml,
                        json: json
            ...
            (function(){
                var appid = 'cyrfTj9BQ',
                conf = 'prod_aaf8e91fc518ca131313d0e7c9f0457';
                var doc = document,
